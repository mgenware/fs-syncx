...
export default class FSSyncx {
  ...
  static pathInfo(path: string, catchExp: any = null): PathInfo|null {
    return FSSyncx.callWrapper<PathInfo|null>(catchExp, path, null, () => {
  ...
  static readTextFile(path: string, catchExp: any = null): string|null {
    return FSSyncx.callWrapper<string|null>(catchExp, path, null, () => fs.readFileSync(path, 'utf8'));
  }

  private static listPathsCore(
    path: string,
    catchExp: any,
